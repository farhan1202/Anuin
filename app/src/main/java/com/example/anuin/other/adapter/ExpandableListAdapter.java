...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    // child data
    private HashMap<Integer, List<HelpModel.DATABean.HelpsGroupBean>> listDataChild;

    public ExpandableListAdapter(Context context, List<HelpModel.DATABean> listDataGroup,
                                 HashMap<Integer, List<HelpModel.DATABean.HelpsGroupBean>> listChildData) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.list_group_help, null);
        }
